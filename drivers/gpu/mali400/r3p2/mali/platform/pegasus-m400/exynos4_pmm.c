...
mali_dvfs_table mali_dvfs[MALI_DVFS_STEPS]={
			/* step 0 */{544  ,1000000	,875000	   , 0   , 70},
			/* step 1 */{640  ,1000000	,900000	   ,62   , 90},
			/* step 2 */{666  ,1000000	,950000	   ,85   , 90},
			/* step 3 */{700  ,1000000	,1025000   ,85   , 90},
			/* step 4 */{800  ,1000000	,1075000   ,95   ,100} };
...
static unsigned int asv_3d_volt_9_table_1ghz_type[MALI_DVFS_STEPS][ASV_LEVEL] = {
	{ 1325000, 1300000, 1300000, 1300000, 1275000, 1275000, 1275000, 1225000, 1225000, 1225000, 1225000,  1225000},  /* L3(600Mhz) */
#if (MALI_DVFS_STEPS > 1)
	{ 1325000, 1300000, 1300000, 1300000, 1275000, 1275000, 1275000, 1225000, 1225000, 1225000, 1225000,  1225000},  /* L2(640Mhz) */
#if (MALI_DVFS_STEPS > 2)
	{ 1325000, 1300000, 1300000, 1300000, 1275000, 1275000, 1275000, 1225000, 1225000, 1225000, 1225000,  1225000},  /* L1(666Mhz) */
#if (MALI_DVFS_STEPS > 3)
	{ 1325000, 1300000, 1300000, 1300000, 1275000, 1275000, 1275000, 1225000, 1225000, 1225000, 1225000,  1225000},  /* L0(700Mhz) */
#if (MALI_DVFS_STEPS > 4)
	{ 1450000, 1437500, 1425000, 1412500, 1400000, 1387500, 1375000, 1362500, 1367500, 1355000, 1355000, 1325000},	/* (800Mhz) */
#endif
#endif
#endif
#endif
...
int mali_gpu_clk = 544;
int mali_gpu_vol = 1325000;
#else
/* Orion */
